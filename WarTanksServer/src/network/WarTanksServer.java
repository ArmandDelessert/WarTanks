...
import network.protocol.SomeResponse;
import network.protocol.SomeRequest;
...
public class WarTanksServer {
    ...
    server.start();
		try {
			...
			Logger.getLogger(WarTanksServer.class.getName()).log(Level.SEVERE, null, ex);
		}
