...
public class Cruiser extends Boat {
    ...
    */
    ...
    private static final String PATH_IMAGE_VERTICAL = "pictures/ships/cruiser_v.gif";
    private static final String PATH_IMAGE_HORIZONTAL = "pictures/ships/cruiser_h.gif";
    
    private BufferedImage imageVertical = null;
    private BufferedImage imageHorizontal = null;
    
    public Cruiser(int cellSize) throws IOException {
        super(LENGTH);
